...
def build_model():
  ...
  x = tf.keras.layers.experimental.preprocessing.RandomCrop(RESIZE_TO, RESIZE_TO)(x)
  x = tf.keras.layers.experimental.preprocessing.RandomRotation(factor=0.04, fill_mode='nearest')(x)
